...
import { AiFillLike, AiTwotoneLike , AiFillFire} from "react-icons/ai";
  ...
  return (
    ...
    >
      <div className="h-screen float-left w-[200px] bg-gray-100 ">
        ...
        <span className="text-xl">{item.icon}</span> <span className="text-lg font-semibold">{item.title}</span>
        </div>
        ))}
